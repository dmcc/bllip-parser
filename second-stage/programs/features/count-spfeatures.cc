...
// This is a modified version of extract-spfeatures.cc which only does feature extraction.
// It does not do any pruning and you must use a separate utility to obtain the full feature
// list.
//
// Mark Johnson, 2nd November 2005, last modified 2nd December 2007
// Additions by David McClosky, 12th March 2008

const char usage[] =
"Usage:\n"
"\n"
"extract-spfeatures-counts [-a] [-c] [-d <debug>] [-f <f>] [-i] [-l] [-s <s>] \n"
"  train.nbest.cmd train.gold.cmd\n"
"\n"
"where:\n"
